      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 max-w-4xl mx-auto">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold">
              Welcome <span className="text-orange-500">{user.firstName} {user.lastName}</span> 👋
            </h2>
            {!isEditing && (
        ...
        {isEditing && (
          <div className="mt-6">
            ...
            <label className="block text-gray-600 mt-4">Last Name</label>
            <input
              type="text"
              value={user.lastName}
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      doc.setFont("helvetica", "normal");
                      doc.setFontSize(10);
                      doc.text(`${user.firstName} ${user.lastName}` || '', 20, billToY + 5);
