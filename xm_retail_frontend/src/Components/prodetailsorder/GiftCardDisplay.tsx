 ...
 */
const GiftCardDisplay: React.FC<GiftCardDisplayProps> = ({ orderData, product, onClose, onCardDisplayReady }) => {
  React.useEffect(() => {
    // Call onCardDisplayReady after animations are complete (approximately 1.5 seconds)
    const timer = setTimeout(() => {
      if (onCardDisplayReady) {
        console.log('🎨 GiftCardDisplay animations complete, calling onCardDisplayReady');
        onCardDisplayReady();
      }
